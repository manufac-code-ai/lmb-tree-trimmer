...
from trimmer.utils import load_ignore_types  # Updated import name

def main():
    # Load ignore types
    ignore_types = load_ignore_types()  # Updated function name

    # Perform filtered scan
    tree_lines, flat_lines, filtered_stats = scan_directory(SOURCE_DIR, ignore_types)
